...
escolheu. PS:é possível que o sistema do Prof. Carvalho apresente erros caso o pokémon
não exista no banco de dados, então não se esqueça de tratá-los também, combinado? */
const pokemons = [
    {
      name: 'Bulbasaur',
      type: 'Grass',
